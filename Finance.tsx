  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">مارکێتینگی دیجیتاڵی</h1>
      ...
      <div className="flex border-b border-gray-200">
        <button
          ...
          className={`px-6 py-3 font-medium text-sm transition-colors border-b-2 ${
            activeTab === 'campaigns' ? 'border-gray-900 text-gray-900' : 'border-transparent text-gray-500 hover:text-gray-700'
          }`}
        >
          کەمپەینەکان
        </button>
        <button
          ...
          className={`px-6 py-3 font-medium text-sm transition-colors border-b-2 ${
            activeTab === 'contracts' ? 'border-gray-900 text-gray-900' : 'border-transparent text-gray-500 hover:text-gray-700'
          }`}
        >
        ...
        {activeTab === 'campaigns' ? (
          <div className="overflow-x-auto">
            <table className="w-full text-right">
              <thead className="bg-gray-50 border-b border-gray-100">
                <tr>
                  <th className="px-6 py-4 text-sm font-semibold text-gray-600">ناوی کەمپەین</th>
              ...
              <tbody className="divide-y divide-gray-100">
                {filteredCampaigns.map((campaign) => (
                  <tr key={campaign.id} className="hover:bg-gray-50 transition-colors group">
                    <td className="px-6 py-4 text-sm text-gray-900 font-medium">{campaign.campaign_name}</td>
                    <td className="px-6 py-4 text-sm text-gray-600">{getClientName(campaign.client_id)}</td>
                    <td className="px-6 py-4 text-sm text-gray-600 flex items-center gap-2">
                      {getPlatformIcon(campaign.platform)} {campaign.platform}
                    </td>
                    <td className="px-6 py-4 text-sm text-gray-600 font-medium" dir="ltr">${campaign.budget?.toLocaleString()}</td>
                    <td className="px-6 py-4 text-sm">
                      <span className={`px-3 py-1 rounded-full text-xs font-medium border ${campaign.status === 'Active' ? 'bg-green-100 text-green-800 border-green-200' : 'bg-gray-100 text-gray-800 border-gray-200'}`}>
                  ...
                  <tr>
                    <td colSpan={6} className="px-6 py-12 text-center text-gray-500">
                      <div className="flex flex-col items-center justify-center">
                        ...
                        <p className="text-lg font-medium text-gray-900">هیچ کەمپەینێک نەدۆزرایەوە</p>
                        <p className="text-sm text-gray-500 mt-1">وشەیەکی تر تاقی بکەرەوە یان کەمپەینی نوێ زیاد بکە.</p>
                      </div>
                    </td>
                  </tr>
                )}
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-right">
              <thead className="bg-gray-50 border-b border-gray-100">
                <tr>
                  <th className="px-6 py-4 text-sm font-semibold text-gray-600">ناوی گرێبەست</th>
                  <th className="px-6 py-4 text-sm font-semibold text-gray-600">مشتەری</th>
                ...
                {filteredContracts.map((contract) => {
                  ...
                  return (
                    <tr key={contract.id} className="hover:bg-gray-50 transition-colors group">
                      <td className="px-6 py-4 text-sm text-gray-900 font-medium">{contract.contract_name}</td>
                      <td className="px-6 py-4 text-sm text-gray-600">{getClientName(contract.client_id)}</td>
                      <td className="px-6 py-4 text-sm text-gray-600">
                      ...
                      <td className="px-6 py-4 text-sm text-gray-600 font-medium" dir="ltr">${contract.monthly_fee?.toLocaleString()}</td>
                      <td className="px-6 py-4 text-sm">
                  ...
                  <tr>
                    <td colSpan={6} className="px-6 py-12 text-center text-gray-500">
                      <div className="flex flex-col items-center justify-center">
                        ...
                        <p className="text-lg font-medium text-gray-900">هیچ گرێبەستێک نەدۆزرایەوە</p>
                        <p className="text-sm text-gray-500 mt-1">وشەیەکی تر تاقی بکەرەوە یان گرێبەستی نوێ زیاد بکە.</p>
                      </div>
                    </td>
                  </tr>
                )}
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-5">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div className="md:col-span-2">
                  <label className="block text-sm font-medium text-gray-700 mb-1.5">ناوی کەمپەین <span className="text-red-500">*</span></label>
                  <input required type="text" value={formData.campaign_name} onChange={e => setFormData({...formData, campaign_name: e.target.value})} className="w-full p-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-gray-900 focus:border-gray-900 transition-shadow" placeholder="ناوی کەمپەین بنووسە..." />
                </div>
                <div className="md:col-span-2">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1.5">پلاتفۆڕم</label>
                  <select value={formData.platform} onChange={e => setFormData({...formData, platform: e.target.value})} className="w-full p-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-gray-900 focus:border-gray-900 transition-shadow">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1.5">بودجە (USD)</label>
                  <input type="number" required value={formData.budget} onChange={e => setFormData({...formData, budget: Number(e.target.value)})} className="w-full p-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-gray-900 focus:border-gray-900 transition-shadow" dir="ltr" placeholder="0.00" />
                </div>
                <div className="md:col-span-2">
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
              ...
              <button onClick={closeContractModal} className="text-gray-400 hover:text-gray-600 transition-colors p-2 hover:bg-gray-100 rounded-full">
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <form onSubmit={handleContractSubmit} className="p-6 space-y-5">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div className="md:col-span-2">
                  <label className="block text-sm font-medium text-gray-700 mb-1.5">ناوی گرێبەست <span className="text-red-500">*</span></label>
                  <input required type="text" value={contractFormData.contract_name} onChange={e => setContractFormData({...contractFormData, contract_name: e.target.value})} className="w-full p-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-gray-900 focus:border-gray-900 transition-shadow" placeholder="بەڕێوەبردنی سۆشیاڵ میدیا" />
                </div>
                <div className="md:col-span-2">
                  <label className="block text-sm font-medium text-gray-700 mb-1.5">مشتەری <span className="text-red-500">*</span></label>
                  <select required value={contractFormData.client_id} onChange={e => setContractFormData({...contractFormData, client_id: e.target.value})} className="w-full p-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-gray-900 focus:border-gray-900 transition-shadow">
                    <option value="">هەڵبژاردنی مشتەری...</option>
                    {clients.map(c => (
                      <option key={c.id} value={c.id}>{c.name} - {c.company}</option>
                    ))}
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1.5">ماوەی گرێبەست (مانگ)</label>
                  <select value={contractFormData.duration_months} onChange={e => setContractFormData({...contractFormData, duration_months: Number(e.target.value)})} className="w-full p-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-gray-900 focus:border-gray-900 transition-shadow">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1.5">بەرواری دەستپێک</label>
                  <input type="date" required value={contractFormData.start_date} onChange={e => setContractFormData({...contractFormData, start_date: e.target.value})} className="w-full p-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-gray-900 focus:border-gray-900 transition-shadow" dir="ltr" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1.5">کرێی مانگانە (USD) <span className="text-red-500">*</span></label>
                  <input type="number" required value={contractFormData.monthly_fee} onChange={e => setContractFormData({...contractFormData, monthly_fee: Number(e.target.value)})} className="w-full p-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-gray-900 focus:border-gray-900 transition-shadow" dir="ltr" placeholder="0.00" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1.5">چەند مانگ پارە دراوە؟</label>
                  <input type="number" required min="0" max={contractFormData.duration_months} value={contractFormData.paid_months} onChange={e => setContractFormData({...contractFormData, paid_months: Number(e.target.value)})} className="w-full p-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-gray-900 focus:border-gray-900 transition-shadow" dir="ltr" />
                </div>
                <div className="md:col-span-2">
                  <label className="block text-sm font-medium text-gray-700 mb-1.5">دۆخ</label>
                  <select value={contractFormData.status} onChange={e => setContractFormData({...contractFormData, status: e.target.value})} className="w-full p-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-gray-900 focus:border-gray-900 transition-shadow">
                    <option value="Active">چالاک</option>
              ...
              <div className="flex justify-end gap-3 pt-4 border-t border-gray-100">
                <button type="button" onClick={closeContractModal} className="px-5 py-2.5 text-gray-600 hover:bg-gray-100 rounded-xl font-medium transition-colors">پاشگەزبوونەوە</button>
                <button type="submit" className="px-5 py-2.5 bg-gray-900 text-white rounded-xl hover:bg-black font-medium transition-colors shadow-sm hover:shadow-md">
      ...
      {showDeleteModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl w-full max-w-sm p-6 text-center shadow-2xl">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">سڕینەوەی کەمپەین</h3>
            <p className="text-gray-500 mb-8">ئایا دڵنیایت لە سڕینەوەی ئەم کەمپەینە؟ ئەم کردارە ناگەڕێتەوە.</p>
      ...
      {showDeleteContractModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl w-full max-w-sm p-6 text-center shadow-2xl">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">سڕینەوەی گرێبەست</h3>
            <p className="text-gray-500 mb-8">ئایا دڵنیایت لە سڕینەوەی ئەم گرێبەستە؟ ئەم کردارە ناگەڕێتەوە.</p>
            <div className="flex justify-center gap-3">
              <button onClick={() => setShowDeleteContractModal(null)} className="px-5 py-2.5 text-gray-600 hover:bg-gray-100 rounded-xl font-medium transition-colors w-full">پاشگەزبوونەوە</button>
